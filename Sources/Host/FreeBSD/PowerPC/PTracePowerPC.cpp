...
ErrorCode PTrace::readCPUState(ProcessThreadId const &ptid,
  ...
  // FreeBSD PowerPC register structure layout
  // Copy GPRs
  ...
  // AltiVec/VMX registers - FreeBSD may not have standard ptrace support
  // Would need to use procfs or sysctl if available
