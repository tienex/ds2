...
ErrorCode Debug::setBreakpoint(task_port_t task, Address addr) { uint32_t o; readMemory(task,addr,&o,4); g_bp[addr]=o; uint32_t tw=0x7FE00008; return writeMemory(task,addr,&tw,4); }
