...
ErrorCode Debug::setBreakpoint(task_port_t task, Address addr) { uint32_t o; readMemory(task,addr,&o,4); g_bp[addr]=o; uint32_t brk=0x00000000; return writeMemory(task,addr,&brk,4); }
