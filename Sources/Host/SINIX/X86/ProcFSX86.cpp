...
ErrorCode ProcFS::readCPUState(ProcessThreadId const &ptid,
  ...
  //
  // SINIX x86 support (Siemens/SNI Unix on Intel x86)
  ...
  //
  // SINIX x86 prgregset_t layout (SVR4 ELF style):
  ...
  // SINIX provides /proc/<pid>/fpregs for x87 FPU
  //
  ...
  // SINIX may provide /proc/<pid>/dbregs
  //
