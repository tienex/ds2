...
//
// GNU/Hurd X86_64 Process - syscall injection
//
...
// GNU/Hurd x86_64 syscall numbers (similar to Linux)
#define __NR_mmap 9
...
static uint8_t const gMunmapCode[] = {
    0x48, 0xc7, 0xc0, 0x00, 0x00, 0x00, 0x00, // 00: movq $sysno, %rax
    0x48, 0xc7, 0xc7, 0x00, 0x00, 0x00, 0x00, // 07: movq $XXXXXXXX, %rdi
    0x48, 0xc7, 0xc6, 0x00, 0x00, 0x00, 0x00, // 0e: movq $XXXXXXXX, %rsi
    0x0f, 0x05,                               // 15: syscall
    0xcc                                      // 17: int3
};
...
static void PrepareMunmapCode(uint64_t address, size_t size,
  ...
  *reinterpret_cast<uint64_t *>(code + 0x0a) = address;
  *reinterpret_cast<uint32_t *>(code + 0x11) = size;
}
