...
ErrorCode PrepareMIPSSoftwareSingleStep(Target::Process *process, uint64_t pc,
                                        Architecture::CPUState const &state,
                                        bool is64bit, uint64_t &nextPC,
                                        uint32_t &nextPCSize, uint64_t &branchPC,
...
ErrorCode PrepareMicroMIPSSoftwareSingleStep(
    ...
    bool is64bit, uint64_t &nextPC, uint32_t &nextPCSize, uint64_t &branchPC,
    uint32_t &branchPCSize);
